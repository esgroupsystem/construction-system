                ...
                <div class="row align-items-center g-3">
                    ...
                    <div class="col-auto d-flex gap-2">
                        @if ($cutoff->status !== 'finalized')
                            <form method="POST" action="{{ route('monthly-timekeeping.cutoffs.finalize', $cutoff->id) }}">
                                @csrf
                                @method('PATCH')
                        ...
                        <a href="{{ route('monthly-timekeeping.index') }}" class="btn btn-falcon-default btn-sm">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card h-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <h6 class="mb-1 text-muted">Payroll Month</h6>
                            <h5 class="mb-0">
                                {{ \Carbon\Carbon::parse($cutoff->date_from)->format('F Y') }}
                            </h5>
                        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <div class="border rounded-3 p-3 h-100">
                            <div class="text-muted fs--1 mb-1">Payroll Month</div>
                    ...
                    <div class="col-md-4">
                        <div class="border rounded-3 p-3 h-100">
                            <div class="text-muted fs--1 mb-1">Covered Period</div>
                            <div class="fw-semibold">
        ...
        <div class="card">
            <div class="card-header bg-light">
                <div class="row align-items-center">
                    <div class="col">
                        <h6 class="mb-0">Active Monthly Employees</h6>
                        <small class="text-muted">Employees included in this monthly cutoff</small>
                    </div>
                            ...
                            @forelse($employees as $employee)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <small class="text-muted">{{ $employee->location ?? 'No location' }}</small>
                                    </td>
                                    ...
                                    <td class="text-center pe-3">
                                        <a href="{{ route('monthly-timekeeping.employees.show', [
                                            'cutoff' => $cutoff->id,
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-5">
                                        <div class="text-muted">
                                            ...
                                            <h6 class="mb-1">No monthly employees found</h6>
