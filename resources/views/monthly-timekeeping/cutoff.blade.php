        ...
        <div class="card mb-3 shadow-sm">
            <div class="card-body">
                <div class="row align-items-center g-3">
                    <div class="col">
                        <h4 class="mb-1">Monthly Timekeeping Details</h4>
            ...
            <div class="col-md-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h6 class="mb-1 mt-1">{{ $employee->department ?? 'N/A' }}</h6>
            ...
            <div class="col-md-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h6 class="mb-1 mt-1">{{ $employee->location ?? 'No location' }}</h6>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-light border-bottom">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="mb-0 fw-bold">Monthly Attendance Report</h6>
                        <small class="text-muted">Complete monthly attendance summary</small>
                    </div>
